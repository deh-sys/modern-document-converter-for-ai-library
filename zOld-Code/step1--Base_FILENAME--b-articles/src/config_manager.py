"""
Configuration manager for article renamer.
...
class ConfigManager:
    ...
    def __init__(self, config_path=None):
        ...
        Args:
            config_path: Optional path to config file (default: .article_config.json in project root)
        """
        if config_path:
            ...
            self.config_path = project_root / '.article_config.json'
